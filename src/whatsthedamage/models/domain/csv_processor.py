...
class CSVProcessor:
    ...
    def process(self) -> Dict[str, Account]:
        """
        Processes the CSV file and returns the Account structure for frontend (API v2).
        Only used for ML categorization.

        Returns:
            Dict[str, Account]: The account-compatible structure for frontend.
        """
